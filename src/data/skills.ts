export const skills = {
  ...
  "Frameworks & Tools": [
    ...
    {
      name: `Angular`,
      logo: `https://upload.wikimedia.org/wikipedia/commons/6/67/Angular_gradient_logo.png`,
      proficiency: `Experienced`,
      description: null
    },
    {
    ...
    {
      name: `SQLAlchemy`,
      logo: `https://upload.wikimedia.org/wikipedia/commons/d/d7/SQLAlchemy.svg`,
      proficiency: `Experienced`,
      description: null
    },
    {
      ...
      proficiency: `Experienced`,
      description: `Robotics middleware & simulation.`
    },
    {
      name: `PyTorch`,
    ...
    {
      name: `LangChain`,
      logo: `https://upload.wikimedia.org/wikipedia/commons/3/3f/LangChain_logo.png`,
      proficiency: `Experienced`,
      description: null
    },
    {
    ...
    {
      name: `Qiskit`,
      logo: `https://upload.wikimedia.org/wikipedia/commons/5/51/Qiskit-Logo.svg`,
    ...
    },
    {
      ...
      proficiency: `Experienced`,
      description: `Scrum & Agile methodologies.`
    }
  ],
  "Cloud & Databases": [
    {
