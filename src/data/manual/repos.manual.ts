...
export const manualRepos: Record<string, RepoProps> = {
  "mcl-ros": {
    ...
    language: "Python",
    homepage: "#",
    previewImage: "/showlit/images/robotics_sim_real.png",
    featured: true,
    category: "research",
  },
  "medical-prescription-ner": {
    ...
    language: "Python",
    homepage: "/showlit/pdf/Final%20Report.pdf",
    previewImage: "/showlit/images/generated/ner_workflow_flowchart.png",
    featured: true,
    category: "coursework",
  },
  "distributed-event-engine": {
    ...
    language: "Python",
    homepage: "/showlit/pdf/distributed_computing_system.pdf",
    previewImage: "/showlit/images/generated/distributed_compute_architecture.png",
    featured: true,
    category: "work",
  },
  ...
  "jssstu-placement-portal": {
    ...
    previewImage: "/showlit/images/placement_portal_logo.png",
    featured: true,
    category: "product",
  },
  "recommendify": {
    ...
    previewImage: "/showlit/images/generated/recommendify_flow_diagram.png",
    featured: true,
    category: "product",
  },
};
